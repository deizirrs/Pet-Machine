...
public class PetMachine {
	...
	public void addWater() {
		...
		water += 2;
		System.out.println("A volume de água no momento está em " + water + " litros(s).");
	}
	...
	public void addShampoo() {
		...
		shampoo += 2;
		System.out.println("A volume de shampoo no momento está em " + shampoo + " litros(s).");
	}
	...
	public void setPet(Pet pet) {
		if (!this.clean) {
			System.out.println("A máquina está suja, para colocar o pet é nescessario limpa -lá.");
			return;
		}
